...
#include "${FamilyName?lower_case}xx_hal_dma2d.h"
...
{
[#if data.parameters.tgfx_mcu_family?? && data.parameters.tgfx_mcu_family == "m7"]
...
void ${FamilyName}DMA::initialize()
{
...
BlitOperations ${FamilyName}DMA::getBlitCaps()
{
...
void ${FamilyName}DMA::setupDataCopy(const BlitOp& blitOp)
{
...
void ${FamilyName}DMA::setupDataFill(const BlitOp& blitOp)
{
    uint8_t bitDepth = HAL::lcd().bitDepth();
